...
const SetImageToDownload = () => {
    const { image, setFrameColor, frameColor, setImage, setStickers, stickers, hashtags, setHashtags } = useAppContext();
    ...
    return (
        <div className="w-full h-full flex items-center justify-around relative overflow-hidden">
            <ImagePreview image={image} frameColor={frameColor} stickers={stickers} hashtags={hashtags} ref={frameRef} />
            <EditFrame setFrameColor={setFrameColor} setStickers={setStickers} setHashtags={setHashtags} hashtags={hashtags} frameRef={frameRef} className={`small-screen:w-[70%] max-[800px]:bg-white small-screen:h-[60vh] max-[800px]:index-10 max-[800px]:absolute
